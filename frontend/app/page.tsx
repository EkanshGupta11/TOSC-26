      ...
      <main className="relative min-h-screen">
        ...
        <header className="relative left-1/2 top-4 z-50 w-full max-w-6xl -translate-x-1/2 border border-white/20 bg-black/20 px-6 backdrop-blur-md">
            ...
            <NavigationMenu>
              <NavigationMenuList className="flex items-center gap-2">
                ...
                <NavigationMenuItem>
                  <NavigationMenuLink
                    href="/about"
                    className="relative flex h-12 items-center px-5 text-lg font-medium text-white
          bg-transparent hover:bg-transparent focus:bg-transparent focus:text-white
          ...
          hover:after:w-full"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger
                className="group flex items-center justify-center rounded-none p-2 outline-none transition-opacity hover:opacity-60 focus-visible:ring-2 focus-visible:ring-white/50"
                aria-label="User menu"
              >
                <User className="h-6 w-6 text-white transition-opacity group-hover:opacity-60 cursor-pointer" />
              </DropdownMenuTrigger>
